<template>
    <div class="min-h-[calc(100dvh)] w-screen flex flex-col items-center bg-black text-white">
        <div
        ...
        <div class="canvas">
            ...
            <div class="house">
                <div class="front">
                    ...
                    <div class="c"></div>
                    <div class="d"></div>
                    <div class="e"></div><span class="f"></span><span class="f"></span><span class="f"></span><span
                        class="f"></span><span class="f"></span><span class="f"></span>
                    <div class="g"></div>
                    <div class="k"></div>
                </div>
                <div class="side">
...
const base64String = ref(route.params.santaId)
const presentee = ref('')
const santaName = ref('')
...
const rawJson = Buffer.from(base64String.value, 'base64').toString('binary')
console.log(rawJson);
...
try {
    ...
    presentee.value = json.presenteeName;
    santaName.value = json.name;
} catch {
    console.log("lol nw");
